...
export const supportedPools = [
   
    {
      ...
      tokenSymbol: 'CNFT',
      token2Symbol: 'WBNB',
      icon: 'https://cnft.cheeseswap.app/cnft-wbnb.svg',
      isHot: true,
      isNew: true,
      rewardValue: '0.45 CNFT',
      apyValue: '6752%',
      protocal: 'CheeseSwap',
      iconProtocal: 'https://cnft.cheeseswap.app/favicon.png',
        ...
        
     {
      ...
      tokenSymbol: 'CNFT',
      token2Symbol: 'CHS',
      icon: 'https://cnft.cheeseswap.app/cnft-chs.svg',
      isHot: true,
      isNew: true,
    ...
    
    {
      ...
      tokenSymbol: 'CNFT',
      token2Symbol: 'BUSD',
      icon: 'https://cnft.cheeseswap.app/cnft-busd.svg',
      isHot: true,
      isNew: true,
      rewardValue: '0.25 CNFT',
      apyValue: '1270%',
    ...
    
    {
      ...
      tokenSymbol: 'CNFT',
      token2Symbol: 'USDT',
      icon: 'https://cnft.cheeseswap.app/cnft-usdt.svg',
      isHot: true,
      isNew: true,
      rewardValue: '0.25 CNFT',
      apyValue: '2010%',
      ...
      tokenSymbol: 'CNFT',
      token2Symbol: 'CNFT',
      icon: 'https://cnft.cheeseswap.app/cnft.svg',
      isHot: true,
      isNew: true,
