    ...
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>
            While the initial creators of the CNFT protocol have made
      ...
      return (
        <div>
          <p>Attention CNFT BurgerSwap LPs</p>
          <p>
            The only BurgerSwap pool that is compatible with CNFT is CNFT-BNB
          </p>
          <p>Providing liquidity for other BurgerSwap pools is dangerous</p>
