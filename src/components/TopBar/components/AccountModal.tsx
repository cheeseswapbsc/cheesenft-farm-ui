...
import { getCnftAddress } from '../../../cnft/utils'
...
import logo from '../../../assets/img/cnft.svg'
                          ...
                          <BoxItem>
                              <Row>
                                  <Col className="col-12">
                                      ...
                                      <TextMedium>
                                          <img src={logo} height="28" alt="CNFT Logo"/><strong> {getBalanceNumber(cnftBalance)}</strong>
                                          <span> <strong>CNFT</strong> </span>
                                      </TextMedium>
                                      {/* <TextMin2>
                                          ~795,6 $
                                      </TextMin2> */}
